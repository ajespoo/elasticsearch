...
public class PagedBytesReference implements BytesReference {
    ...
    public static final ByteBuf EMPTY_BYTEBUF = new EmptyByteBuf(ByteBufAllocator.DEFAULT);
    ...
    public ByteBuf toByteBuf() {
        ...
        //return Unpooled.wrappedBuffer(NettyUtils.DEFAULT_GATHERING, buffers);
